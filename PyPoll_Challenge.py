...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (cvotes > largest_turnout_count) and (cvote_percentage > winning_percentage):
            # If true then set winning_count = votes and winning_percent =
            # vote_percentage.
            largest_turnout_count = cvotes
            county_largest_turnout = county_name
    
    county_large_turnout_txt = (f"-------------------------\n"
    f"Largest County Turnout: {county_largest_turnout}\n"
    f"-------------------------\n")

    # 7: Print the county with the largest turnout to the terminal.
    print(county_large_turnout_txt)

    # 8: Save the county with the largest turnout to a text file.

    txt_file.write(county_large_turnout_txt)
